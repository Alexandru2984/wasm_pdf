...
The delivered vertical slices implement merge, split, rotate, reorder and crop
in WASM. The same engine boundary is intended for flatten, text extraction, watermark,
